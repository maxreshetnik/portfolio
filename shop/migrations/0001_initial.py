# Generated by Django 3.2.3 on 2022-03-25 17:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='specs', to='shop.category')),
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(django.contrib.postgres.search.SearchVector('name', 'marking', config='english'), name='tvproduct_vector_idx'),
        ),
        migrations.AddIndex(
            model_name='specification',
            index=django.contrib.postgres.indexes.GinIndex(django.contrib.postgres.search.SearchVector('tag', config='english'), name='shop_specification_vector_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(django.contrib.postgres.search.SearchVector('name', 'marking', config='english'), name='smartphoneproduct_vector_idx'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddIndex(
            ...
            index=django.contrib.postgres.indexes.GinIndex(django.contrib.postgres.search.SearchVector('name', 'marking', config='english'), name='foodproduct_vector_idx'),
        ),
        migrations.AddIndex(
            model_name='clothingproduct',
            index=django.contrib.postgres.indexes.GinIndex(django.contrib.postgres.search.SearchVector('name', 'marking', config='english'), name='clothingproduct_vector_idx'),
        ),
        migrations.AddIndex(
            model_name='category',
            index=django.contrib.postgres.indexes.GinIndex(django.contrib.postgres.search.SearchVector('name', config='english'), name='shop_category_vector_idx'),
        ),
    ]
